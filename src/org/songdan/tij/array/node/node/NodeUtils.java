...
public final class NodeUtils {
     ...
     * @return 具备树形结构的头节点
     */
    public static <T> Node<T> buildNode(Node<T> head,Collection<T> collection,INodeHierarchy<T> nodeHierarchy) {
        /*
        1，选出子节点
        2，对子节点递归
         */
        ...
        for (T t : list) {
            if (nodeHierarchy.isHierarchy(head.getValue(),t)) {
                ...
                //递归调用
                head.getSonList().add(buildNode(new Node<>(t),tempList,nodeHierarchy));
            }
        }
        return head;
    }
